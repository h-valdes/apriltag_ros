#include "apriltag_ros/partial_detector.h"

#include <pluginlib/class_list_macros.h>

PLUGINLIB_EXPORT_CLASS(apriltag_ros::PartialDetector, nodelet::Nodelet);

namespace apriltag_ros {
void PartialDetector::onInit() {
    ...
    this->is_ir_sub = nh.subscribe(
        "/filtered_camera/is_ir", 1, &PartialDetector::is_ir_callback, this);

    camera_image_subscriber_ =
        it_->subscribeCamera("image_rect", 1,
                             &PartialDetector::imageCallback, this);
...
void PartialDetector::is_ir_callback(const std_msgs::Bool::ConstPtr& msg) {
    this->is_ir = msg->data;
}

void PartialDetector::imageCallback(
